      ...
      <section className="max-w-[1200px] mx-auto px-6 pt-16 pb-12">
        ...
        >
          ...
          {study.links && study.links.length > 0 && (
            <div className="flex flex-wrap gap-2 mb-4 ml-3 inline-flex">
              {study.links.map((link, i) => (
                <a
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full border border-[#016634]/20 text-[#016634]/80 text-xs hover:bg-[#016634]/10 transition-colors"
            ...
            <div className="flex flex-wrap gap-2 mb-4 ml-3 inline-flex">
              {study.links.map((link, i) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full border border-white/20 text-white/70 text-xs hover:bg-white/10 transition-colors"
                  style={{ fontFamily: "'IBM Plex Mono', monospace", fontWeight: 500 }}
                >
                  <svg viewBox="0 0 24 24" className="w-3 h-3" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" />
